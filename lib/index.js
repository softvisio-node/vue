...
export default class App extends Events {
    ...
    async initSession () {
        ...
        // if ( res.ok ) {
        //     this.#api.on( "connect", this.#checkAuthorization.bind( this ) );

        //     this.api.on( "authorizationRequired", () => this._onAuthorizationRequired() );
