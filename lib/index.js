...
export default class App extends Events {
    ...
    #settings = {};
    #user = {};
    #checkAuthorizationMutex = new Mutex();
    #oauthWindow;
    #signingOut;
    ...
    async init () {
        ...
        if ( config.app.apiUrl ) {
            this.#api = Api.new( config.app.apiUrl, {
                ...
                "onAuthorization": this._onAuthorization.bind( this ),
            } );
    ...
    async initSession () {
        ...
        this.#api.on( "contextDisabled", this.#signout.bind( this, { "showAlert": true } ) );
        this.#api.on( "contextDeleted", this.#signout.bind( this, { "showAlert": true } ) );
    }
    ...
    // XXX push notifications
    async #signout ( { res, showAlert, signout } = {} ) {
        ...
        // sign out
        if ( signout ) await this.#api.call( "session/signout" );
