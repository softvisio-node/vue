...
export default class extends Store {
    ...
    async enablePushNotifications () {
        ...
        this.#pushNotificationsData.enabled[this.userId || GUEST_USER_ID] = true;
    ...
    async disablePushNotifications () {
        ...
        this.#pushNotificationsData.enabled[this.userId || GUEST_USER_ID] = false;
        this.#storePushNotificationsData();
    ...
    #initPushNotifications () {
        ...
        if ( this.isAuthenticated ) {
            ...
            enable = this.#pushNotificationsData.enabled[GUEST_USER_ID] || !!process.env.APP_PUSH_NOTIFICATIONS_GUEST_ENABLED;
        }
    ...
    async #registerPushNotificationsToken ( token ) {
        ...
        if ( res.ok ) {
            ...
            this.#pushNotificationsData.userId = this.userId || GUEST_USER_ID;
            this.#storePushNotificationsData();
