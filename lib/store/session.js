...
export default class extends Store {
    ...
    async checkAuthentication () {
        var checkPushNotifications = true;
    ...
    // private
    async #enablePushNotifications () {
        if ( !this.pushNotificationsSupported ) return result( [500, locale.i18nd( "vue", "Push notifications are not suppported" )] );
