...
export default class extends Store {
    ...
    constructor () {
        ...
        this.$api.on( "signout", () => this._setSession() );
    }
    ...
    set title ( title ) {
        ...
        if ( process.env.VUE_APP_TITLE_ICON ) title = process.env.VUE_APP_TITLE_ICON + " " + title;
    ...
    _setSession ( data ) {
        ...
        // authenticated
        if ( data && data.auth ) {
            this.isAuthenticated = !!data.auth.user_id;
            this.userId = data.auth.user_id || null;
