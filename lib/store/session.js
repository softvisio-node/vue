...
var mutations = {
    ...
    darkMode ( state, darkMode ) {
        ...
        this.dispatch( "applyDarkMode", darkMode );
    },
    ...
    theme ( state, theme ) {
        ...
        this.dispatch( "applyTheme", theme );
    },
...
var actions = {
    init ( ctx ) {
        ...
        this.dispatch( "applyDarkMode", ctx.state.darkMode );
        this.dispatch( "applyTheme", ctx.state.theme );
    },

    async signin ( ctx, credintials ) {
        var res = await this.$api.call( "session/signin", credintials );
