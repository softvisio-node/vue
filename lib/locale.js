...
class Locale extends CoreLocale {
    ...
    // properties
    get defaultLocale () {
        return process.env.APP_DEFAULT_LOCALE || DEFAULT_LOCALE;
    }
...
if ( !process.env.APP_DEFAULT_LOCALE || !LOCALES[process.env.APP_DEFAULT_LOCALE] ) process.env.APP_DEFAULT_LOCALE = DEFAULT_LOCALE;
