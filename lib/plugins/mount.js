...
export default {
    install ( app, options ) {
         ...
         * cache: cache component instance internally, default true
         *
         * returns vue component instance
         * instance: the instance of the component provided
         */
        app.config.globalProperties.$mount = async function ( component, { el, props, children, cache = true } = {} ) {
            ...
            if ( cache && COMPONENTS_CACHE.has( component ) ) return COMPONENTS_CACHE.get( component );
            ...
            vnode.$unmount = function () {
                if ( this.component?.isMounted && !this.component?.isUnmounted ) {
                    ...
                    if ( cache ) COMPONENTS_CACHE.delete( this.type );
                }
            };
            ...
            if ( cache ) COMPONENTS_CACHE.set( component, instance );
