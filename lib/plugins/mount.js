...
export default {
    install ( app, options ) {
         ...
         * noCache: do not cache component instance internally
         *
         * returns vue component instance
         * instance: the instance of the component provided
         */
        app.config.globalProperties.$mount = async function ( component, { el, props, children, noCache } = {} ) {
            ...
            if ( !noCache && COMPONENTS_CACHE.has( component ) ) return COMPONENTS_CACHE.get( component );
            ...
            vnode.$unmount = function () {
                if ( this.component?.isMounted && !this.component?.isUnmounted ) {
                    ...
                    if ( !noCache ) COMPONENTS_CACHE.delete( this.type );
                }
            };
            ...
            if ( !noCache ) COMPONENTS_CACHE.set( component, instance );
